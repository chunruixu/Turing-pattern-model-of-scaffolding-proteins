...
p.ukdephoCpdR=0.5;  
try
load('F:\My Drive\Kartik PopZ\opt15_correctionCheck\OPT6\MultiGA_Output12.mat','val');
  catch
load('G:\My Drive\Kartik PopZ\opt15_correctionCheck\OPT6\MultiGA_Output12.mat','val');
    end
  para=val(7,:);
%    p.alpha_PopZPodJ=70;%1;%PodJ on PopZ
  para(1)=0.035; 
  para(27)=30;% 
%   para(32)=200; 
  para(33)=400;
 try
load('F:\My Drive\Kartik PopZ\opt15_correctionCheck2\OPT7\MultiGA_Output41.mat','val');
  catch
load('G:\My Drive\Kartik PopZ\opt15_correctionCheck2\OPT7\MultiGA_Output41.mat','val');
    end
  para=val(3,:); 
  para(41)=6;
  ...
  %%%OPT10com
   try
load('F:\My Drive\Kartik PopZ\opt15_10com\OPT10com\MultiGA_Output13.mat','val');
  catch
load('G:\My Drive\Kartik PopZ\opt15_10com\OPT10com\MultiGA_Output13.mat','val');
    end
  para=val(3,:); 
...
%  p.depho_DivK=80;%para(20)
%  p.pho_DivKDivJb=100;%para(19)
%  p.kp_cckA2=600;%para(32)
%  p.TS=5;
elseif ver==2  %3
         p.D_podJm =100;%for PopZ only & 100 in manuscript;  
p.D_podJL =0.0005;%40;%0.0005;  
...
p.ukdephoCpdR=0.5;  
      %%%OPT10com
      try
load('F:\My Drive\Kartik PopZ\opt15_10com\OPT10com\MultiGA_Output16.mat','val');
  catch
load('G:\My Drive\Kartik PopZ\opt15_10com\OPT10com\MultiGA_Output16.mat','val');
    end
  para=val(11,:); 
  para(41)=0.1*para(41);
  p.syn_podJ2=para(1);   p.Ji_PodJCtrA=para(2);  p.syn_spmx=para(3);  p.Ja_SpmXCtrA=para(4); p.syn_ctrA1=para(5); 
...
load('G:\My Drive\Kartik PopZ\opt15_10com\OPT10com\MultiGA_Output16.mat','val');
  ...
  para=val(11,:); 
  para(41)=0.65;%0.1*para(41);
  para(2)=2;%3;
  para(1)=0.02;

try
load('F:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output22.mat','val');
  catch
load('G:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output22.mat','val');
    end
para=val(1,:); 
para(2)=2;
% try
% load('F:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output29.mat','val');
%   catch
% load('G:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output29.mat','val');
%     end
% para=val(2,:); 
  p.syn_podJ2=para(1);   p.Ji_PodJCtrA=para(2);  p.syn_spmx=para(3);  p.Ja_SpmXCtrA=para(4); p.syn_ctrA1=para(5); 
p.syn_ctrA2=para(6);  p.Ja_CtrACtrA=para(7);  p.deg_ctrA2=para(8); p.Jd_CpdR=para(9); p.syn_pleC=para(10); 
...
%     end
% para=val(1,:); 
% para(2)=2; para(19)=180;
try
load('F:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output31.mat','val');
  catch
load('G:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output31.mat','val');
    end
para=val(7,:);

para(22)=2.2; para(21)=1.55;

% try
% load('F:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output34.mat','val');
%   catch
% load('G:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output34.mat','val');
%     end
% para=val(2,:);
% para(22)=2.2; para(21)=1.55;
% para(19)=125;  %para(27)=65;
% p.alpha_PopZPodJ=100;
% para(18)=0.4;
...
% para(18)=0.4;
try
load('F:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output40.mat','val');
  catch
% load('G:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output36.mat','val');
  load('/Volumes/GoogleDrive/My Drive/Kartik PopZ/opt15_10com_hillfunction2andfixedseparationtime/OPT10com/MultiGA_Output40.mat','val');
end
para=val(2,:);
%  para(19)=60; para(33)=500;
% para(20)=70;
  p.syn_podJ2=para(1);   p.Ji_PodJCtrA=para(2);  p.syn_spmx=para(3);  p.Ja_SpmXCtrA=para(4); p.syn_ctrA1=para(5); 
p.syn_ctrA2=para(6);  p.Ja_CtrACtrA=para(7);  p.deg_ctrA2=para(8); p.Jd_CpdR=para(9); p.syn_pleC=para(10); 
p.fb_PleC=para(11); p.b_PleCDivKP=para(12); p.ub_DivJDivKP=para(13); p.ub_DivJDivK=para(14); p.syn_divK2=para(15); 
...
load('G:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output40.mat','val');
%   load('/Volumes/GoogleDrive/My Drive/Kartik PopZ/opt15_10com_hillfunction2andfixedseparationtime/OPT10com/MultiGA_Output40.mat','val');
end
para=val(2,:);
% p.b_CtrAPCckAph=4;
...
try
load('F:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output76.mat','val');
  catch
load('G:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output76.mat','val');
%   load('/Volumes/GoogleDrive/My Drive/Kartik PopZ/opt15_10com_hillfunction2andfixedseparationtime/OPT10com/MultiGA_Output47.mat','val');
end
para=val(6,:);
...
try
load('F:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output54.mat','val');
  catch
% load('G:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output54.mat','val');
  load('/Volumes/GoogleDrive/My Drive/Kartik PopZ/opt15_10com_hillfunction2andfixedseparationtime/OPT10com/MultiGA_Output54.mat','val');
end
para=val(3,:);
  p.syn_podJ2=para(1);   p.Ji_PodJCtrA=para(2);  p.syn_spmx=para(3);  p.Ja_SpmXCtrA=para(4); p.syn_ctrA1=para(5); 
p.syn_ctrA2=para(6);  p.Ja_CtrACtrA=para(7);  p.deg_ctrA2=para(8); p.Jd_CpdR=para(9); p.syn_pleC=para(10); 
...
try
load('F:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output66.mat','val');
  catch
load('G:\My Drive\Kartik PopZ\opt15_10com_hillfunction2andfixedseparationtime\OPT10com\MultiGA_Output66.mat','val');
%   load('/Volumes/GoogleDrive/My Drive/Kartik PopZ/opt15_10com_hillfunction2andfixedseparationtime/OPT10com/MultiGA_Output47.mat','val');
end
para=val(7,:);
...
% elseif strcmp(mutant,'PodJ++')
%      p.syn_podJ = p.syn_podJ*3.5;
% p.syn_podJ2 = p.syn_podJ2*3.5;
