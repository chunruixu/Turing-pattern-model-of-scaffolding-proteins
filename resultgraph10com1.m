...
% ylabel('scaled concentration')
h = legend('DivJ_T','DivJ_f','DivJ_b','Wheeler 99','Sanselicio 15','Radhakrishnan 07','Location', 'North','fontsize',LegendSize,'NumColumns',3);
  set(h, 'Interpreter', 'tex', 'Box', 'on', 'Orientation', 'vertical');
...
% xlabel('time (min)','fontsize',LabelSize)
ylabel('scaled concentration')
h = legend('PleC_T','PleC_{ph}','PleC_{kin}','Viollier 02','Guo 04','Location', 'North','fontsize',LegendSize,'NumColumns',3);
 set(h, 'Interpreter', 'tex', 'Box', 'on', 'Orientation', 'vertical');
...
h = legend('CtrA_T','CtrA~P','Weston 21','Radhakrishnan 07','Jacobs 03','Location', 'North','fontsize',LegendSize,'NumColumns',3);
set(h, 'Interpreter', 'tex', 'Box', 'on', 'Orientation', 'vertical');
    end
