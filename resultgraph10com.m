 function resultgraph2(yout,tout,celltype,mutant,TITLE,concentration)
% close all
%spatial plots
%%simulation
...
set(gcf,'position',[100 100 1100 500])%left, lower, right, upper

set(gcf,'Name',TITLE);
% ha = tight_subplot(5,2,[.1 .03],[.1 .04],[.1 .04]);
ha = tight_subplot(3,4,[.1 .03],[.1 .1],[.05 .04]);
